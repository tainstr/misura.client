...
standards = {
    ...
    'Saffire': (
        ...
        np.array([5.11, 5.52, 5.86, 6.15, 6.39, 6.61, 6.81, 6.98, 7.13, 7.26, 7.38, 7.49, 7.59, 7.68, 7.77, 7.86,
                  7.94, 8.02, 8.10, 8.17, 8.25, 8.32, 8.39, 8.46, 8.54, 8.61, 8.67, 8.74, 8.81, 8.88, 8.95]) * 10**-6
    ),
}
