...
class ReportPlugins(unittest.TestCase):
    ...
    def test_hsm(self):
        """Create HSM report"""
        self.verify_plugin(
            'test_video.h5', '0:hsm/sample0', 'report_hsm.vsz', 'Vol')

    def test_horizontal(self):
        """Create Horizontal Dilatometer report"""
        self.verify_plugin(
            'test_horizontal.h5', '0:horizontal/sample0', 'report_horizontal.vsz', 'd')

    def test_vertical(self):
        """Create Vertical Dilatometer report"""
        self.verify_plugin(
            'test_vertical.h5', '0:vertical/sample0', 'report_vertical.vsz', 'd')

    def test_flex(self):
        """Create Flex report"""
        self.verify_plugin(
            'test_flex.h5', '0:flex/sample0', 'report_flex.vsz', 'd')
