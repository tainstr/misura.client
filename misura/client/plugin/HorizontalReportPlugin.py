...
class HorizontalReportPlugin(OperationWrapper,plugins.ToolsPlugin):
	...
	def apply(self, cmd, fields):
		...
		d=os.path.join(params.pathArt,'report_horizontal.vsz')
		...
		msg = wr('Measure',measure['name'], 25, '\\\\')
		msg += '\\\\\\\\' + wr('Sample',sample['name'], 25, '\\\\')
...
# 		self.toset(page.getChild('shapes'),'label',msg)
		...
		self.dict_toset(doc.resolveFullWidgetPath(report_path+'/temp/ax:d'),cf)
		self.apply_ops()
