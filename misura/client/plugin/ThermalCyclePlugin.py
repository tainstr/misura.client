...
def cycleFormat(t, T):
	...
	t=numpy.array(t); T=numpy.array(T)
	dt=numpy.diff(t); dT=numpy.diff(T)
	rates=dT/dt
...
class ThermalCyclePlugin(plugins.ToolsPlugin):
	...
	def __init__(self,test=None):
		"""Make list of fields."""
		self.fields = [ 
			FieldMisuraNavigator("test", descr="Target test:", depth='test',default=test),
		]
