...
from_base = {'length': {'micron': lambda v: v,
    ...
    'specific heat': {'J/gK': lambda v: v},
    'density': {'g/cm3': lambda v: v},
    'thermal resistance': {'cm2K/W': lambda v: v},
...
derivatives = {'length': {'micron': 1,
    ...
    'specific heat': {'J/gK': 1},
    'density': {'g/cm3': 1},
    'thermal resistance': {'cm2K/W': 1},
    'weight': {'gram': 1,
               'kilogram': 1E-3,
               'milligram': 1E3
               },
