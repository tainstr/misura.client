...
class Designer(unittest.TestCase):
    ...
    def test_steps_template_to_thermal_cycle_curve(self):
        ...
        self.assertEqual([[0.0, 0], [3000.0, 1000], [3120.0, 1000]],
        ...
        self.assertEqual([[0.0, 0], [1200.0, 1200], [1320.0, 1200]],
        ...
        self.assertEqual([[0.0, 0], [1200.0, 1200], [1300.0, 1200]],
        ...
        self.assertEqual([[0.0, 0], [1200.0, 1200], [1320.0, 1200], [1440, 1320], [1560, 1320]],
